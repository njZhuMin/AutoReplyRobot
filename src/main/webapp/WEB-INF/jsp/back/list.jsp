...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background: #e1e9eb;">
		<form action="<%=basepath%>List.action" id="mainForm" method="post" accept-charset="UTF-8">
			<div class="right">
				<div class="current">当前位置：<a href="javascript:void(0)" style="color:#6E6E6E;">内容管理</a> &gt; 内容列表</div>
				<div class="rightCont">
					<p class="g_title fix">内容列表
						<a class="btn03" href="#">新 增</a>&nbsp;&nbsp;&nbsp;&nbsp;
						<a class="btn03" href="javascript:deleteMulti('<%=basepath%>')">删 除</a>
					</p>
					<table class="tab1">
						<tbody>
							<tr>
								...
								<td>
									<input name="description" type="text" class="allInput" value="${message.id}" />
								</td>
